...
export interface NewsItem { id: string; title: string; summary: string; source: string; url?: string; publishedAt: string; relatedSymbols: string[]; relatedPersonIds?: string[]; origin?: 'rss' | 'mock'; fallbackReason?: string; rssContent?: string; contentSnippet?: string; articleText?: string }
